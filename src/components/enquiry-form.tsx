...
import { Phone, User, Home, MessageSquare, Send, Mail, MapPin, IndianRupee } from "lucide-react"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.mailtoLink && confirm("Service is down. Open email client?")) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                <MapPin className="h-12 w-12 mr-4 text-highlight flex-shrink-0" />
            ...
            <CardHeader className="bg-gradient-to-r from-cta to-blue-700 text-white rounded-t-lg">
              ...
              <p className="text-center text-white/90 text-sm">
                {submitStatus === "success"
                  ? "Your enquiry has been sent successfully and SMS confirmation sent!"
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    required
                  >
                    <SelectTrigger className="w-full h-12 border-2 border-gray-300 focus:border-cta rounded-lg bg-white">
                  ...
                  >
                    ...
                    <SelectContent className="bg-white border border-gray-300 shadow-lg">
                      {priceRanges.map((range) => (
                        <SelectItem key={range} value={range} className="cursor-pointer hover:bg-gray-100">
                          <div className="flex items-center gap-2">
                            <IndianRupee className="h-4 w-4 text-gray-500 flex-shrink-0" />
                            <span>₹{range}</span>
                          </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Textarea
                      ...
                      placeholder="Tell us about your requirements, preferred location, amenities, etc..."
                    />
                  </div>
                </div>
                ...
                >
                  {isSubmitting ? (
                    ...
                    <>
                      ...
                      Send Enquiry & Get Confirmation Email
                    </>
                  )}
                </Button>
