...
export default function IndependentHousesPage() {
    ...
    <div className="pt-16">
      ...
      <section className="py-40 relative min-h-[90vh] flex items-center">
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/images/Ih_2.avif')`,
          }}
        ></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/80 text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed drop-shadow-lg">
            Spacious family homes with private compounds, perfect for growing
            families seeking comfort and privacy in Hyderabad
          </p>
        </div>
      </section>
                  ...
                  <div className="w-full h-64 overflow-hidden">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        target.src =
                          "/placeholder.svg?height=256&width=400&text=House";
                      }}
                    />
                  </div>
