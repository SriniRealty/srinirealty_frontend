...
function BuyPropertyPageInner() {
    ...
    if (typeParam) {
      typeMatched = properties.some(
        (property) =>
          ...
          property.property_type.toLowerCase().includes(typeParam.toLowerCase())
      );
    }
  ...
  const getPropertyTypeCounts = () => {
    ...
    properties.forEach((property) => {
      if (property.property_type) {
        counts[property.property_type] =
          (counts[property.property_type] || 0) + 1;
      }
    });
    return counts;
  };
  ...
  const getStatusMessage = () => {
    ...
    const { locationMatched, typeMatched, requestedLocation, requestedType } =
      filterStatus;
    ...
    if (requestedLocation && locationMatched) {
      ...
      return {
        type: "none",
        message: `Sorry, we couldn't find properties in ${requestedLocation}. Showing all available properties instead.`,
        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-8">
              Discover premium properties available for purchase. Each property
              is carefully selected and verified by our expert team at Srini
              Realty.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Badge
                variant="secondary"
                className="px-6 py-3 text-lg bg-gray-300 text-purple-600 shadow-md"
              >
                {filteredProperties.length} Properties Available
              </Badge>
              {/* <Button
                onClick={() => router.push("/admin/upload-property")}
                className="px-6 py-3 text-lg bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white shadow-lg font-semibold"
              >
                <Building2 className="h-5 w-5 mr-2" />
                Upload SRINI Property
              </Button> */}
              <div className="flex justify-center mb-8">
                <Button
                  onClick={() => router.push("/property-selling?srini=true")}
                  className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-6 py-3 text-lg font-semibold shadow-lg"
                >
            ...
            <div className="mb-6">
              <div className="flex flex-wrap gap-2">
                {selectedPropertyType && (
                  <Badge
                    variant="secondary"
                    className="px-4 py-2 bg-blue-100 text-blue-800"
                  >
                    Type: {selectedPropertyType}
                    <button
                      onClick={() =>
                        handlePropertyTypeChange(selectedPropertyType)
                      }
                ...
                {selectedLocation && (
                  <Badge
                    variant="secondary"
                    className="px-4 py-2 bg-purple-100 text-purple-800"
                  >
                ...
                <Tooltip key={property.id}>
                  <TooltipTrigger asChild>
                    <div className="relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 cursor-pointer h-96 w-full group border border-gray-100">
                      <div className="absolute inset-0">
                        <Image
                          src={
                            getPropertyImage(property.property_type, index) ||
                            "/placeholder.svg"
                          }
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      />
                      <div className="text-sm bg-white/30 p-2 rounded-lg">
                        <p className="font-semibold text-brown-700">
                          Contact Srini Realty
                        </p>
          ...
          <div className="mt-20 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl shadow-xl p-8 text-center text-white">
            ...
            <p className="text-blue-100 mb-8 text-lg">
              Our expert team is here to help you find the ideal property that
